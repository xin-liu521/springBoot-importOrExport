                    ...
                    <div class="col-sm-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>北京新骑手工资结果${year!}年${month!}月 </h5>
                            </div>
...
<script>
    ...
    $(function () {
        $table = $('#orderTable').bootstrapTable({
            ...
            url:path+"/resultDetail/queryNewResultDetailPage?recordId="+$("#recordId").val(),
...
//                {field:"leave",title:"事假",align:"center",valign:"middle"},
                ...
                {field:"complete_proportion",title:"完成率≧99%",align:"center",valign:"middle",sortable:"true"},
                {field:"on_time_proportion",title:"准时率≧96%",align:"center",valign:"middle"},
//                {field:"deliver_score",title:"配送评分",align:"center",valign:"middle"},
                ...
                {field:"night_number",title:"21:00-23:00单量",align:"center",valign:"middle",sortable:"true"},
                {field:"night_price",title:"补贴（1/单）",align:"center",valign:"middle",sortable:"true", formatter : valueFormatter},
                {field:"big_night_number",title:"23:00-3:00单量",align:"center",valign:"middle",sortable:"true"},
                {field:"big_night_price",title:"补贴（2元/单）",align:"center",valign:"middle",sortable:"true", formatter : valueFormatter},
                {field:"interval_price",title:"阶梯提成",align:"center",valign:"middle",sortable:"true", formatter : valueFormatter},
                {field:"interval_two_number",title:"90≤-<200单量",align:"center",valign:"middle"},
                {field:"interval_two_price",title:"奖励(2元)",align:"center",valign:"middle", formatter : valueFormatter},
                {field:"interval_three_number",title:"200≤-<400单量",align:"center",valign:"middle",sortable:"true"},
                {field:"interval_three_price",title:"奖励(4元)",align:"center",valign:"middle",sortable:"true", formatter : valueFormatter},
                ...
                {field:"interval_five_price",title:"奖励(12元)",align:"center",valign:"middle",sortable:"true", formatter : valueFormatter},
                ...
                {field:"distance_two_price",title:"奖励(1.5元)",align:"center",valign:"middle",sortable:"true", formatter : valueFormatter},
...
//                {field:"addressTwo",title:"开户行",align:"center",valign:"middle",sortable:"true"},
    ...
    function exportFile(){
        ...
        window.location.href = path+"/resultDetail/exportNewResultDetail?recordId="+$("#recordId").val()+"&riderName="+riderName+"&stataionId="+
